...
(function () {
    ...
    window.champions.vis = {
        "title": "Final Champions League 2017",
        "description": "Real Madrid vs. Juventus. Powered by CARTO.",
        "user": {
        ...
        "layers": [
            ...
            },
            {
                ...
                "options": {
                    ...
                    "sql": "select cartodb_id, the_geom_webmercator, postedtime, category_name from champions_17 where category_number is not null",
                    "visible": true,
