        ...
        "layers": [
            ...
            },
            {
                ...
                "options": {
                    ...
                    "sql": "select *, (CASE WHEN \"category_name\" = 1 THEN 'Real Madrid' WHEN \"category_name\" = 2 THEN 'Real Madrid' WHEN \"category_name\" = 3 THEN 'Cristiano' WHEN \"category_name\" = 4 THEN 'Bale' WHEN \"category_name\" = 5 THEN 'James' WHEN \"category_name\" = 6 THEN 'Ramos' WHEN \"category_name\" = 7 THEN 'Navas' WHEN \"category_name\" = 8 THEN 'Marcelo' WHEN \"category_name\" = 9 THEN 'Benzema' WHEN \"category_name\" = 10 THEN 'Pepe' WHEN \"category_name\" = 11 THEN 'Modric' WHEN \"category_name\" = 12 THEN 'Kroos' WHEN \"category_name\" = 13 THEN 'Resto de jugadores' END) as jugador, (CASE WHEN \"category_name\" = 1 THEN 1 WHEN \"category_name\" = 2 THEN 2 WHEN \"category_name\" = 3 THEN 3 WHEN \"category_name\" = 4 THEN 4 WHEN \"category_name\" = 5 THEN 5 WHEN \"category_name\" = 6 THEN 6 WHEN \"category_name\" = 7 THEN 7 WHEN \"category_name\" = 8 THEN 8 WHEN \"category_name\" = 9 THEN 9 WHEN \"category_name\" = 10 THEN 10 WHEN \"category_name\" = 11 THEN 11 WHEN \"category_name\" = 12 THEN 12 WHEN \"category_name\" = 13 THEN 13 END) as torque_category FROM (SELECT * FROM final_champions_2016) _cdb_wrap",
                    "visible": true,
