        ...
        "layers": [
            ...
            },
            {
                ...
                "options": {
                    ...
                    "cartocss": "/** torque_cat visualization */\n\nMap {\n-torque-frame-count:256;\n-torque-animation-duration:30;\n-torque-time-attribute:\"postedtime\";\n-torque-aggregation-function:\"CDB_Math_Mode(torque_category)\";\n-torque-resolution:2;\n-torque-data-aggregation:linear;\n}\n\n#final_champions_2016{\n  comp-op: source-over;\n  marker-fill-opacity: 0.9;\n  marker-line-color: #FFF;\n  marker-line-width: 0;\n  marker-line-opacity: 1;\n  marker-type: ellipse;\n  marker-width: 6;\n  marker-fill: #0F3B82;\n}\n#final_champions_2016[frame-offset=1] {\n marker-width:8;\n marker-fill-opacity:0.45; \n}\n#final_champions_2016[frame-offset=2] {\n marker-width:10;\n marker-fill-opacity:0.225; \n}#final_champions_2016[value=3] {\n   marker-fill: #B2DF8A;\n}\n#final_champions_2016[value=4] {\n   marker-fill: #33A02C;\n}\n#final_champions_2016[value=5] {\n   marker-fill: #FB9A99;\n}\n#final_champions_2016[value=6] {\n   marker-fill: #E31A1C;\n}\n#final_champions_2016[value=7] {\n   marker-fill: #FDBF6F;\n}\n#final_champions_2016[value=8] {\n   marker-fill: #FF7F00;\n}\n#final_champions_2016[value=9] {\n   marker-fill: #CAB2D6;\n}\n#final_champions_2016[value=10] {\n   marker-fill: #B2DF8A;\n}\n#final_champions_2016[value=11] {\n   marker-fill: #33A02C;\n}\n#final_champions_2016[value=13] {\n   marker-fill: #FB9A99;\n}\n#final_champions_2016[value=14] {\n   marker-fill: #E31A1C;\n}\n#final_champions_2016[value=15] {\n   marker-fill: #FDBF6F;\n}\n#final_champions_2016[value=16] {\n   marker-fill: #FF7F00;\n}\n#final_champions_2016[value=17] {\n   marker-fill: #CAB2D6;\n}\n#final_champions_2016[value=18] {\n   marker-fill: #B2DF8A;\n}\n#final_champions_2016[value=19] {\n   marker-fill: #33A02C;\n}\n#final_champions_2016[value=20] {\n   marker-fill: #FB9A99;\n}\n#final_champions_2016[value=21] {\n   marker-fill: #E31A1C;\n}\n#final_champions_2016[value=22] {\n   marker-fill: #FDBF6F;\n}\n#final_champions_2016[value=23] {\n   marker-fill: #FF7F00;\n}\n#final_champions_2016[value=24] {\n   marker-fill: #CAB2D6;\n}\n#final_champions_2016[value=25] {\n   marker-fill: #6A3D9A;\n}#final_champions_2016[value=26] {\n   marker-fill: #FF7F00;\n}\n#final_champions_2016[value=27] {\n   marker-fill: #CAB2D6;\n}\n#final_champions_2016[value=28] {\n   marker-fill: #B2DF8A;\n}\n#final_champions_2016[value=29] {\n   marker-fill: #33A02C;\n}\n#final_champions_2016[value=30] {\n   marker-fill: #FB9A99;\n}\n#final_champions_2016[value=31] {\n   marker-fill: #E31A1C;\n}\n#final_champions_2016[value=32] {\n   marker-fill: #FDBF6F;\n}\n#final_champions_2016[value=33] {\n   marker-fill: #FF7F00;\n}\n#final_champions_2016[value=34] {\n   marker-fill: #CAB2D6;\n}\n#final_champions_2016[value=35] {\n   marker-fill: #6A3D9A;\n}\n#final_champions_2016 {\n   marker-fill: #FFFFFF;\n}",
                    "sql": "select *, (CASE WHEN \"category_name\" = 3 THEN 'Zidane' WHEN \"category_name\" = 4 THEN 'Bale' WHEN \"category_name\" = 5 THEN 'Ramos' WHEN \"category_name\" = 6 THEN 'Cristiano' WHEN \"category_name\" = 7 THEN 'Navas' WHEN \"category_name\" = 8 THEN 'Pepe' WHEN \"category_name\" = 9 THEN 'Modric' WHEN \"category_name\" = 10 THEN 'Vázquez' WHEN \"category_name\" = 11 THEN 'Casemiro' WHEN \"category_name\" = 12 THEN 'James' WHEN \"category_name\" = 13 THEN 'Kroos' WHEN \"category_name\" = 14 THEN 'Benzema' WHEN \"category_name\" = 15 THEN 'Bale' WHEN \"category_name\" = 16 THEN 'Isco' WHEN \"category_name\" = 7 THEN 'Carvajal' WHEN \"category_name\" = 18 THEN 'Marcelo' WHEN \"category_name\" = 19 THEN 'Verane' WHEN \"category_name\" = 20 THEN 'Nacho' WHEN \"category_name\" = 21 THEN 'Casilla' WHEN \"category_name\" = 22 THEN 'Yáñez' WHEN \"category_name\" = 33 THEN 'Kovacic' WHEN \"category_name\" = 34 THEN 'Jesé' WHEN \"category_name\" = 35 THEN 'Arbeloa' ELSE NULL END) as player, (CASE WHEN \"category_name\" = 3 THEN 3 WHEN \"category_name\" = 4 THEN 4 WHEN \"category_name\" = 5 THEN 5 WHEN \"category_name\" = 6 THEN 6 WHEN \"category_name\" = 7 THEN 7 WHEN \"category_name\" = 8 THEN 8 WHEN \"category_name\" = 9 THEN 9 WHEN \"category_name\" = 10 THEN 10 WHEN \"category_name\" = 11 THEN 11 WHEN \"category_name\" = 13 THEN 13 WHEN \"category_name\" = 14 THEN 14 WHEN \"category_name\" = 15 THEN 15 WHEN \"category_name\" = 16 THEN 16 WHEN \"category_name\" = 17 THEN 17 WHEN \"category_name\" = 18 THEN 18 WHEN \"category_name\" = 19 THEN 19 WHEN \"category_name\" = 20 THEN 20 WHEN \"category_name\" = 21 THEN 21 WHEN \"category_name\" = 22 THEN 22 WHEN \"category_name\" = 23 THEN 23 WHEN \"category_name\" = 24 THEN 24 WHEN \"category_name\" = 25 THEN 25 WHEN \"category_name\" = 26 THEN 26 WHEN \"category_name\" = 27 THEN 27 WHEN \"category_name\" = 28 THEN 28 WHEN \"category_name\" = 29 THEN 29 WHEN \"category_name\" = 30 THEN 30 WHEN \"category_name\" = 31 THEN 31 WHEN \"category_name\" = 32 THEN 32 WHEN \"category_name\" = 33 THEN 33 WHEN \"category_name\" = 34 THEN 34 WHEN \"category_name\" = 35 THEN 35 ELSE NULL END) as torque_category FROM (SELECT * FROM final_champions_2016) _cdb_wrap",
                    "visible": true,
